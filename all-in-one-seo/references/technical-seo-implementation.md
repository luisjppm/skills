...
Provide framework-oriented implementation patterns for technical SEO in modern
web apps.

## Load When

- You need implementation examples for metadata, sitemaps, canonicals, and redirects.
- You are integrating SEO requirements into app framework code.
- You are operationalizing performance and crawler policies in production.

## Quick Checklist

- [ ] Implement metadata, canonical, and robots logic in templates.
- [ ] Automate sitemap and redirect flows from source-of-truth data.
- [ ] Validate performance targets and crawler access rules.
- [ ] Verify internationalization and hreflang behavior where needed.

## Pair With

- `seo-foundations-playbook.md`
