...
Provide editorial QA rules for reducing machine-like phrasing and improving
natural, human-sounding output.

## Load When

- You are polishing SEO or AEO content before publish.
- You need a fast pass to remove common AI writing tells.
- You are reviewing tone consistency across high-importance pages.

## Quick Checklist

- [ ] Remove unnecessary em dashes and inflated transitions.
- [ ] Replace vague verbs/adjectives with specific language.
- [ ] Remove filler intensifiers that add no meaning.
- [ ] Read final copy aloud for natural phrasing.
