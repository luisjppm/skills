...
Provide reusable content block templates for AEO and GEO output formats,
including definitions, how-to, comparisons, FAQ, evidence, and voice patterns.

## Load When

- You are drafting or rewriting content for AI extraction and citation.
- You need repeatable section templates for specific query intents.
- You need domain-specific or voice-search answer structures.

## Quick Checklist

- [ ] Match each page section to a clear query intent.
- [ ] Select the correct block type for each section.
- [ ] Add statistics, sources, and attribution where claims are made.
- [ ] Keep answer passages self-contained and directly extractable.
