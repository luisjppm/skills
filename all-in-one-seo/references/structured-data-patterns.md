...
Provide JSON-LD schema patterns, composition strategies, and rendering/testing
guidance for production sites.

## Load When

- You are implementing or refactoring structured data.
- You need schema examples for common content types.
- You need `@graph`, serialization, or validation guidance.

## Quick Checklist

- [ ] Select schema types that match visible page content.
- [ ] Include freshness and entity fields where relevant.
- [ ] Validate rendered JSON-LD with Rich Results Test.
- [ ] Re-test after template or CMS changes.
