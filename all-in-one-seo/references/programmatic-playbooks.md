...
Catalog repeatable pSEO playbook types, value requirements, and URL patterns
for opportunity selection.

## Load When

- You need to choose which pSEO playbook fits available assets.
- You need concrete pattern and URL examples for a playbook.
- You are combining multiple playbooks into one rollout.

## Quick Checklist

- [ ] Select playbook(s) that match defensible assets and intent.
- [ ] Confirm value requirements are met before page generation.
- [ ] Confirm URL and internal-link structures are scalable.
- [ ] Confirm combinations do not create cannibalization.

## Pair With

- `programmatic-seo-playbook.md`
